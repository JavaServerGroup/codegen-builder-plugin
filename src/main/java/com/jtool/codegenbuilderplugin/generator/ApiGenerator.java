...
//                ClassName requestPojoClass = null;
//                if(StringUtils.isNotBlank(requestPojoName)) {
//                    requestPojoClass = ClassName.get(apiPackageName + ".request", requestPojoName);
//                }
//
...
//                        methodSpecBuilder = MethodSpec.methodBuilder("getParams")
...
//
//                    //匿名类GsonRequest
//                    TypeSpec.Builder gsonRequestAnonymousClass = TypeSpec.anonymousClassBuilder("$N, $N, $N, $N, $N", "com.android.volley.Request.Method." + codeGenModel.getHttpMethod(), "url", responsePojoName + ".class", "onResponseListener", "onErrorListener")
//                            .addSuperinterface(ParameterizedTypeName.get(gsonRequestClass, responsePojoClass));
//
//                    if(requestPojoClass != null) {
//                        gsonRequestAnonymousClass.addMethod(methodSpecBuilder.build());
//                    }
//
//                    //api的发送请求方法
//                    MethodSpec.Builder sentRequestBuilder = MethodSpec.methodBuilder("sentRequest")
...
//                            .addParameter(ParameterizedTypeName.get(listenerClass, responsePojoClass), "onResponseListener", Modifier.FINAL)
//                            .addParameter(errorListenerClass, "onErrorListener", Modifier.FINAL)
//                            .addStatement("return $L", gsonRequestAnonymousClass.build());
//
//                    if(requestPojoClass != null) {
//                        sentRequestBuilder.addParameter(requestPojoClass, "bean", Modifier.FINAL);
//                    }
//
//                    apiClassTypeSpec = typeSpecBuilder.addMethod(sentRequestBuilder.build()).build();
//                }
